...
export default function NerdsPage() {
  return <main className="nerd-page">
    ...
    <nav className="nerd-index" aria-label="Kapitel">
      <a href="#state">01 Zustandsprozess</a><a href="#likelihood">02 Likelihood</a><a href="#priors">03 Priors</a><a href="#transition">04 Übergang</a><a href="#inference">05 Inferenz</a><a href="#score">06 Bewertung</a>
    </nav>

    <section className="math-section" id="state">
      <div className="math-section__heading"><span>01</span><div><div className="eyebrow">Latenter Zustandsraum</div><h2>Zwei zeitabhängige Stärken pro Team.</h2></div></div>
    ...
    <section className="math-section math-section--dark" id="likelihood">
      <div className="math-section__heading"><span>02</span><div><div className="eyebrow">Torintensität &amp; Beobachtungsmodell</div><h2>Stärken werden zu erwarteten Chancen.</h2></div></div>
    ...
    <section className="math-section" id="priors">
      <div className="math-section__heading"><span>03</span><div><div className="eyebrow">Saisonstart</div><h2>Zwei Priors, dieselbe Modellstruktur.</h2></div></div>
    ...
    <section className="math-section math-section--acid" id="transition">
      <div className="math-section__heading"><span>04</span><div><div className="eyebrow">Produktions-Policy</div><h2>Carry wird nicht gewählt, sondern ausgeblendet.</h2></div></div>
    ...
    <section className="math-section" id="inference">
      <div className="math-section__heading"><span>05</span><div><div className="eyebrow">Posterior-Inferenz</div><h2>Single-Site Metropolis-Hastings.</h2></div></div>
      <div className="inference-flow"><article><b>1</b><h3>Proposal</h3><code>θ′ = θ + Normal(0, 0,06²)</code><p>Angriff und Abwehr werden an jedem lokalen Teamzustand einzeln vorgeschlagen.</p></article><article><b>2</b><h3>Acceptance</h3><code>α = min(1, posterior′ / posterior)</code><p>Nur die betroffene lokale Likelihood und die angrenzenden Zeitpriors müssen neu berechnet werden.</p></article><article><b>3</b><h3>Mixture update</h3><code>δ′ = 1 − δ</code><p>Der Bernoulli-Indikator jedes Spiels wird als eigener diskreter Zustand aktualisiert.</p></article><article><b>4</b><h3>Identifikation</h3><code>Σa + Σd = 0</code><p>Nach jeder Iteration wird der globale Leveldrift entfernt. Warm Starts beschleunigen aufeinanderfolgende Stichtage.</p></article></div>
    </section>

    <section className="math-section math-section--dark" id="score">
      <div className="math-section__heading"><span>06</span><div><div className="eyebrow">Posterior Predictive &amp; Evaluation</div><h2>Von λ zu fairen Quoten.</h2></div></div>
